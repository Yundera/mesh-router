...
$containerName = "mesh-router-provider-test2.localhost"
$dockerfilePath = "../../.."
...
try {
    ...
    -e PROVIDER_ANNONCE_DOMAIN=test2.localhost `
    -e VPN_ENDPOINT_ANNOUNCE=dprovider2 `
    -e VPN_IP_RANGE='2.0.0.0/24' `
    -e VPN_PORT=51821 `
    -p 8080:80 `
    -p 51821:51821/udp `
    --network provider `
